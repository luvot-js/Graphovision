...
def _rule_based_report(scores: list[float]) -> str:
    ...
    reframe = {
        ...
        "유연성":         ("주변에 휘둘리지 않고 줏대 있는 사람",           "내면의 균형이 잘 잡혀 어디서든 안정감을 주는 사람"),
        "독립성":         ("사교적이고 에너지 넘치는 관계의 중심인 사람",    "독립적이고 자기만의 세계가 깊은 사람"),
    }
...
3. 부정적인 의미의 지표를 긍정적이고 매력적인 단어로 리프레이밍(Reframing) 하세요.
   - 예: '독립성'이 높다면 -> "독립적이고 자기만의 세계가 깊은 사람"
   - 예: '유연성'이 낮다면 -> "주변에 휘둘리지 않고 줏대 있는 사람"
